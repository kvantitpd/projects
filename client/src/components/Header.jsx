...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`w-full bg-deepblue text-white  ${justifyCenter} text-xs md:text-sm py-1 relative`}
      >
          ...
          <ul className={`h-[45px] flex gap-5 md:gap-9 ${justifyCenter}`}>
            <li>
              <div className={`${justifyCenter} hidden sm:flex gap-2`}>
                ...
                <a href='mailto:KvantoriumPerm@gmail.com'>
            ...
            <li className='hidden text-xs xxl:block'>
              <a href='http://perminnovation.ru/' target='_blanc'>
                ЧОУ ДПО Центр Инновационного развития человеческого <br />
                потенциала и управления знаниями
              </a>
            </li>
            <li className='gap-4 hidden xs:flex'>
              <a href='https://vk.com/kvantorium.fotonika' target='_blanc'>
                <i className='fab fa-vk fa-xl'></i>
              </a>
              <a href='https://t.me/kvantoriumperm' target='_blanc'>
      ...
      <div className='w-full bg-slate-500 text-sm md:text-xl text-white h-[100px] flex items-center justify-center uppercase font-bold'>
        Проекты ДТ "Кванториум Фотоника" Пермь
      </div>
    </>
  );
};
